...
called a [traceback](../python/reference.html#traceback).
Let's examine one:
...
So, in this case, the program first performed a [function call](../python/reference.html#function-call) to the function `favorite_ice_cream`.
...
you will encounter a [syntax error](../python/reference.html#syntax-error).
...
> Because they are both [whitespace](../python/reference.html#whitespace),
...
The first is that you meant to use a [string](../python/reference.html#string), but forgot to put quotes around it:
...
Remember that variables are [case-sensitive](../python/reference.html#case-sensitive),
